...
class MusicApi {
  ...
  ///匹配音乐播放地址
  static Future<Answer> matchMusic({String? name, String? artist, bool myfreemp3 = false}) async {
    ...
    try {
      var value = await Future.wait([
        ...
        myfreemp3 ? MyFreeMp3.search(keyWord: keyWord) : Future.value(const Answer()),
