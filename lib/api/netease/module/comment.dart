...
Future<Answer> _commentMv (Map params, List<Cookie> cookie) {
  ...
  return request(
      'POST',
      'https://music.163.com/weapi/v1/resource/comments/R_MV_5_${params["id"]}',
      data,
      crypto: Crypto.weApi,
      cookies: cookie);
}
...
Future<Answer> _commentPlaylist (Map params, List<Cookie> cookie) {
  ...
  return request(
      'POST',
      'https://music.163.com/weapi/v1/resource/comments/A_PL_0_${params["id"]}',
      data,
      crypto: Crypto.weApi,
      cookies: cookie);
}
...
Future<Answer> _commentVideo (Map params, List<Cookie> cookie) {
  ...
  return request(
      'POST',
      'https://music.163.com/weapi/v1/resource/comments/R_VI_62_${params["id"]}',
      data,
      crypto: Crypto.weApi,
      cookies: cookie);
}
...
Future<Answer> _commentNew (Map params, List<Cookie> cookie) {
  ...
  final data = {
    ...
    'cursor':
        params['sortType'] == 3 ? params['cursor'] ?? 0 : (pageNo - 1) * pageSize,
    'sortType': params['sortType'] ?? 1 //1:按推荐排序,2:按热度排序,3:按时间排序
  };
