              ...
              child: ListView(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      QQ.albumInfo(albumMid: "002ONiEz3DG90b").then(onData).catchError(onError);
                    },
                  ),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      QQ.playlistInfo(id: 7559427528).then(onData).catchError(onError);
                    },
                  ),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      QQ.rankInfo(topId: 62).then(onData).catchError(onError);
                    },
                  ),
                  ListTile(
